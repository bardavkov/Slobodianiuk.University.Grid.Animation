...
function generateETCLOADPROJECT(): IFrame[] {
    ...
    const number4: IPixelState[] = [
        { x: 2, y: 2, color: Colour.White }, { x: 2, y: 3, color: Colour.White }, { x: 4, y: 4, color: Colour.White },
        { x: 3, y: 2, color: Colour.White },
        { x: 4, y: 2, color: Colour.White }, { x: 4, y: 7, color: Colour.White }, { x: 4, y: 4, color: Colour.White },
        { x: 5, y: 4, color: Colour.White },
        { x: 6, y: 4, color: Colour.White },
    ];
    ...
    const lettersOk: IPixelState[] = [
        { x: 12, y: 2, color: Colour.White }, { x: 2, y: 3, color: Colour.White }, { x: 12, y: 4, color: Colour.White },
        { x: 13, y: 2, color: Colour.White }, { x: 13, y: 4, color: Colour.White },
        { x: 14, y: 2, color: Colour.White }, { x: 9, y: 8, color: Colour.White }, { x: 4, y: 4, color: Colour.White },
    ];
